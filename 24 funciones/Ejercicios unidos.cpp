...
void edadActual1(int anioNac, int mesNac, int diaNac)
{
     // https://foroayuda.es/obtener-la-fecha-actual-en-el-ejemplo-de-codigo-c/
    time_t t = time(0);// Obtiene la fecha actual desde el sistema
    tm* now = localtime(&t);
...
int main ()
{
    ...
    //Ejercicio 20
    cout<<endl;
    cout<<endl<<"Ejercicio 20";
    cout<<endl;
    Edad(2002, 11, 9);

    //Ejercicio 21
    cout<<endl<<"Ejercicio 21";
    ...
    int mesNac = 11;
    int diaNac = 9;
    edadActual1(anioNac, mesNac, diaNac);
    cout<<endl;
    cout<<endl;
    Edad(7186);
    ...
    //Ejercicio 24
    cout<<endl;
    cout<<endl<<"Ejercicio 24";
    cout<<endl<<"n1 cuesta 30 y n2 cuesta 20";
    int n1=30; int n2=20;
    intercambio(n1,n2);
    cout<<endl<<"a cuesta 72 y b cuesta 26";
    int a=72; int b=26;
    intercambio(a,b);
    //Para llamar
    cout<<endl;
    cout<<endl<<"Ahora n1 es: "<<n1<<" y n2 es: "<<n2;
    cout<<endl<<"Ahora a es: "<<a<<" y b es: "<<b;
