...
{
    int elegir;
    cout<<endl<<"Elige la opción que quieres probar";
    cout<<endl<<"1. Buscar porcentaje de un número";
    cout<<endl<<"2. Pagar mensualmente un producto";
    cout<<endl<<"3. Interés de un producto";
    cout<<endl<<"4. Convertir de dólar a otra moneda"<<endl;
    cin>>elegir;
